...
#define MAIN_DISPLAY_TREND_STATS_RANGE_Y 196u
#define MAIN_DISPLAY_TREND_STATS_MAX_Y 226u
#define MAIN_DISPLAY_TREND_STATS_MIN_Y 256u
#define MAIN_DISPLAY_TREND_STATS_AVG_Y 286u
