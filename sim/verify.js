...
check("authentic labels",["REMOTE","TALK","LSTN","SRQ","TRIG"].every(x=>e.STATUS.includes(x)));
...
check("trend stat slots + row2 range",html.includes("slotX=[120,420,720]")&&html.includes('"+rangeTxt,COLORS.white]')&&html.includes('"MAX "+fmtStat(hi)+axisUnit'));
